...
27. [IV值](https://www.jianshu.com/p/bd350351aa5c)
...
29. 特征的归一化处理：决策树类算法不需要，神经网络中的图片识别会做归一化处理,knn算法因为要计算数据距离所以也需要归一化处理
...
简单理解,就是在损失函数后分别跟着L1范数(绝对值和)和L2范数(平方和).
...
34. 逻辑回归:线性回归+sigmoid函数(线性回归应用于分类问题)
